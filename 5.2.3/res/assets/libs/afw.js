...
/**
 * @namespace afw.afw_01
 * @namespace afw.afw_04
 * @namespace afw.afw_07
 * @namespace afw.afw_11
 * @namespace afw.afw_12
 * @namespace afw.afw_13
 * @namespace afw.afw_14
 * @namespace afw.afw_18
 * @namespace afw.afw_19
 * @namespace afw.afw_21
 * @namespace afw.afw_25
 */
if (afw.afw_01 === null || typeof (afw.afw_01) != "object") {
    afw.afw_01 = {};
}
if (afw.afw_04 === null || typeof (afw.afw_04) != "object") {
    afw.afw_04 = {};
}
if (afw.afw_07 === null || typeof (afw.afw_07) != "object") {
    afw.afw_07 = {};
}
if (afw.afw_11 === null || typeof (afw.afw_11) != "object") {
    afw.afw_11 = {};
}
if (afw.afw_12 === null || typeof (afw.afw_12) != "object") {
    afw.afw_12 = {};
}
if (afw.afw_13 === null || typeof (afw.afw_13) != "object") {
    afw.afw_13 = {};
}
if (afw.afw_14 === null || typeof (afw.afw_14) != "object") {
    afw.afw_14 = {};
}
if (afw.afw_18 === null || typeof (afw.afw_18) != "object") {
    afw.afw_18 = {};
}
if (afw.afw_19 === null || typeof (afw.afw_19) != "object") {
    afw.afw_19 = {};
}
if (afw.afw_21 === null || typeof (afw.afw_21) != "object") {
    afw.afw_21 = {};
}
if (afw.afw_25 === null || typeof (afw.afw_25) != "object") {
    afw.afw_25 = {};
}

/**
 * @namespace afw.afw_01.mesg
 */
afw.afw_01.mesg = {
    afich_boite_mesg: function (pjs_optio) {
        ...
        if (vob_boite_mesgs.length > 0) {
            //vob_boite_mesgs.html('<div class="ui-widget" style="padding: 0 .7em;" id="' + vjs_optio.vva_clas_notfc + '">' + '  <div class="ui-state-error ui-corner-all" style="margin-bottom: 3px; padding: 0 .7em;">' + '    <p>' + '      <span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>' + '      ' + vjs_optio.vva_mesg + '    </p>' + '  </div>' + '</div>');

            vob_boite_mesgs.html('<div id="afw_notfc_mesg" class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>' + vjs_optio.vva_mesg + '</div>');
        } else {
    ...
    gestn_err_apex: function () {
        ...
        afw.afw_01.mesg.afich_boite_mesg({
            vva_mesg: vva_pile_errs,
            vva_clas_mesgs: "afw_mesg_apex",
            vva_clas_notfc: "afw_mesg_ereur"
        });
    },
    trait_err_apex: function (pnu_forcr_mode_debug) {
        var vob_apex_err_page_mesg = afw.jQuery("div.ErrorPageMessage");
        var vob_afw_mesg_err = afw.jQuery("#afw_mesg_err");
        var vob_afw_bloc_err = afw.jQuery("#afw_bloc_err");
        ...
        if (vob_afw_mesg_err.length > 0 && vob_afw_mesg_err.html() != "") {
            vva_pile_errs = vob_afw_mesg_err.html() + (vva_pile_errs == null ? "" : "<br />" + vva_pile_errs);
        }

        if (afw.afw_07.debug.verif_debug_actif || pnu_forcr_mode_debug == 1) {
            // Afficher l'erreur directement à l'écran
            afw.afw_01.mesg.afich_boite_mesg({
                vva_mesg: vva_pile_errs,
                vva_clas_mesgs: "afw_bloc_err",
                vva_clas_notfc: "afw_mesg_ereur"
            });

            vob_afw_bloc_err.css("display", "block");
        } else {
...
afw.afw_07.debug = {
    ...
    trace: function (pjs_optio, pnu_forcr_debug) {
        ...
        if (afw.afw_07.debug.verif_debug_actif || pnu_forcr_debug == 1) {
            if (afw.afw_07.debug.verif_consl_actif) {
                console.log('Trace debug: ' + afw.afw_07.debug.vnu_seqnc);
                console.log(vjs_optio.vva_mesg);
            } else {
                alert('Trace debug: ' + afw.afw_07.debug.vnu_seqnc);
                alert(vjs_optio.vva_mesg);
            }
            afw.afw_07.debug.vnu_seqnc++;
        }
    },
    deplc_apex_dev_tolbr: function () {
        afw.jQuery("#apex-dev-toolbar").appendTo("#afw_toolbar_bas");
    }
};

/**
 * @namespace afw.afw_07.temn
 */
afw.afw_07.temn = {
...
/**
 * @namespace afw.afw_12.favr
 */
afw.afw_12.favr = {
    _ajout: function (p_icone, pnu_struc_aplic, pnu_seqnc_struc_aplic) {
        var vjs_optio = {
            aplic_procs: 'AFW_12_FAVR_AJOUT_FAVR',
            x01: pnu_struc_aplic,
            x02: pnu_seqnc_struc_aplic,
            sucs_procs: function (p_data) {
                p_icone.toggleClass('afw_12_suprm_favr');
                p_icone.toggleClass('afw_12_ajout_favr');
    ...
    _suprm: function (p_icone, pnu_struc_aplic, pnu_seqnc_struc_aplic) {
        var vjs_optio = {
            aplic_procs: 'AFW_12_FAVR_SUPRM_FAVR',
            x01: pnu_struc_aplic,
            x02: pnu_seqnc_struc_aplic,
            sucs_procs: function (p_data) {
                p_icone.toggleClass('afw_12_suprm_favr');
    ...
    ajout_suprm: function (pthis, pnu_struc_aplic, pnu_seqnc_struc_aplic) {
        ...
        if (icone.hasClass('afw_12_suprm_favr')) {
            afw.afw_12.favr._suprm(icone, pnu_struc_aplic, pnu_seqnc_struc_aplic);
        } else if (icone.hasClass('afw_12_ajout_favr')) {
            afw.afw_12.favr._ajout(icone, pnu_struc_aplic, pnu_seqnc_struc_aplic);
        }
    }
};

/**
 * @namespace afw.afw_13.page
 */
afw.afw_13.page = {
    ...
    cachr_animt_charg: function () {
        afw.jQuery("#apex_wait_popup,#apex_wait_overlay,.u-Processing").remove();
    },
    animt_charg: function (pbo_afich) {
        if (pbo_afich) {
            afw.afw_13.page.afich_animt_charg();
        } else {
            afw.afw_13.page.cachr_animt_charg();
        }
    },
    obten_numr_apex: function () {
    ...
    soumt_defnr_valr_afw: function (pjs_optio) {
        ...
        afw.afw_13.page.soumt_defnr_valr_item(vjs_optio);
    },
    ...
    forml_tablr: {
        defnr_item_apex: function (pThis, pnu_index, pva_valr) {
            var coln_forml_tablr = afw.jQuery(pThis).closest("td");

            afw.jQuery("input[name^='f0" +
                pnu_index + "']", coln_forml_tablr
            ).val(pva_valr);
        }
    }
};
...
/**
 * @namespace afw.afw_18.tablr_form
 */
afw.afw_18.tablr_form = {
...
/**
 * @namespace afw.afw_19.fonct
 */
afw.afw_19.fonct = {
    aide_page_item: {
        id_item: "",
        defnr_item: function (pnu_item_id_apex) {
            afw.afw_19.fonct.aide_page_item.id_item = pnu_item_id_apex;
        },
        fonct: ""
    }
};
...
/**
 * @namespace afw.afw_19.boutn
 */
afw.afw_19.boutn = {
    fonct: {
        aide_page_item: "afw.afw_19.boutn.exect_fonct_javsc(afw.afw_19.fonct.aide_page_item.fonct);"
    },
...
/**
 * @namespace afw.afw_25.entet_vertc
 */
afw.afw_25.entet_vertc = {
    formt: function () {
...
/**
 * @namespace afw.afw_07.stock_local
 */
afw.afw_07.stock_local = {
    defnr_item: function (pva_nom, pva_valr) {
        if (typeof (pva_valr) == 'object') {
            pva_valr = afw.afw_07.json.convr_chain(pva_valr);
        }
    ...
    obten_item: function (pva_nom, pva_type) {
        ...
        if (pva_type == "json") {
            return afw.afw_07.json.convr_objet(vva_valr);
        } else {
            return vva_valr;
        }
    },
...
/**
 * @namespace afw.afw_07.stock_sesn
 */
afw.afw_07.stock_sesn = {
    defnr_item: function (pva_nom, pva_valr) {
        if (typeof (pva_valr) == 'object') {
            pva_valr = afw.afw_07.json.convr_chain(pva_valr);
        }
