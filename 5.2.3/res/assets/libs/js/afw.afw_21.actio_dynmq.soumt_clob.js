/**
 * @namespace afw.afw_21.actio_dynmq.soumt_clob
 */
afw.afw_21.actio_dynmq.soumt_clob = {
    insta: [],
    obten: function (pnu_id) {
        var vjs_insta;

        for (var i = 0; i < afw.afw_21.actio_dynmq.soumt_clob.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.soumt_clob.insta[i].id == pnu_id) {
                vjs_insta = afw.afw_21.actio_dynmq.soumt_clob.insta[i];
                break;
            }
        }
    ...
    suprm: function (pnu_id) {
        for (var i = 0; i < afw.afw_21.actio_dynmq.soumt_clob.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.soumt_clob.insta[i].id == pnu_id) {
                afw.afw_21.actio_dynmq.soumt_clob.insta.splice(i, 1);
            }
        }
    },
    /**
