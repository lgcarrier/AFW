/**
 * @namespace afw.afw_21.regn.arbre
 */
afw.afw_21.regn.arbre = {
    insta: [],
    /**
     * @constructor
     */
    arbre: function (pjs_optio) {
        ...
        function obten_stock_sesn_json_arbre() {
            return afw.afw_07.stock_sesn.obten_item(that.stock_sesn_json_arbre, "json");
        } //END obten_stock_sesn_json_arbre

        function obten_stock_sesn_json_type_noeud() {
            return afw.afw_07.stock_sesn.obten_item(that.stock_sesn_json_type_noeud, "json");
        } //END obten_stock_sesn_json_type_noeud

        function obten_stock_sesn_json_arbre_string() {
            return afw.afw_07.stock_sesn.obten_item(that.stock_sesn_json_arbre);
        } //END obten_stock_sesn_json_arbre_string

        function obten_stock_sesn_json_type_noeud_string() {
            return afw.afw_07.stock_sesn.obten_item(that.stock_sesn_json_type_noeud);
        } //END obten_stock_sesn_json_type_noeud_string

        function obten_stock_sesn_stat_plugn() {
            return afw.afw_07.stock_sesn.obten_item(that.stock_sesn_stat_plugn);
        } //END obten_stock_sesn_stat_plugn

        function suprm_stock_sesn() {
            afw.afw_07.stock_sesn.suprm_item(that.stock_sesn_json_arbre);
            afw.afw_07.stock_sesn.suprm_item(that.stock_sesn_json_type_noeud);
            afw.afw_07.stock_sesn.suprm_item(that.stock_sesn_rafrc_arbre);
            afw.afw_07.stock_sesn.suprm_item(that.stock_sesn_stat_plugn);
        ...
        function initl(pjs_optio) {
            ...
            if (that.node) {
                ...
                that.stock_sesn_rafrc_arbre = "afw.afw_21.regn.arbre." + that.optio.vva_seqnc_plugn + ".rafrc_json_arbre";
                that.stock_sesn_json_arbre = "afw.afw_21.regn.arbre." + that.optio.vva_seqnc_plugn + ".json_arbre";
                that.stock_sesn_json_type_noeud = "afw.afw_21.regn.arbre." + that.optio.vva_seqnc_plugn + ".json_type_noeud";
                that.stock_sesn_stat_plugn = "afw.afw_21.regn.arbre." + that.optio.vva_seqnc_plugn + ".stat_plugn";

                // Initiliaser l'arbre
                if (that.optio.vva_mode_cache == "AUCUN" || that.optio.vbo_rafrc_arbre || that.jQuery.isEmptyObject(obten_stock_sesn_json_arbre())) {
                    //console.log('CACHE AUCUN');
                    // Obtenir JSON types de noeuds
                    // Obtenir JSON arbre
                    that._obten_json_initl_arbre();
                }
                else if (afw.afw_07.stock_sesn.obten_item(that.stock_sesn_rafrc_arbre) == "1" && !that.jQuery.isEmptyObject(obten_stock_sesn_json_arbre())) {
        ...
        function _defnr_json_arbre(pjs_data) {
            afw.afw_07.stock_sesn.defnr_item(that.stock_sesn_rafrc_arbre, 1);
            afw.afw_07.stock_sesn.suprm_item(that.stock_sesn_rafrc_arbre);
            afw.afw_07.stock_sesn.defnr_item(that.stock_sesn_json_arbre, pjs_data);
            that.optio.vjs_arbre = pjs_data;
            _initl_arbre();
        } //END _defnr_json_arbre

        function _defnr_json_type_noeud(pjs_data) {
            afw.afw_07.stock_sesn.defnr_item(that.stock_sesn_json_type_noeud, pjs_data);
        ...
        function _initl_arbre() {
            try {
                        ...
                        "dnd": {
                            ...
                            "drag_finish": function (data) {
                                that.jQuery.exec_aplic_procs({
                                    ...
                                    "x02": data.r.attr("id"),
                                    "sucs_procs": function () {
                                        afw.afw_13.page.item.defnr_valr(that.optio.vva_item_fin_actio_glisr_elemn_arbre, data.o.id);
                                    }
                                });
                            }
                        },
                ...
                afw.afw_07.stock_sesn.defnr_item(that.stock_sesn_stat_plugn, that.optio.vjs_mesg.vva_stat_ok);
            }
            catch (e) {
                afw.afw_07.stock_sesn.defnr_item(that.stock_sesn_stat_plugn, that.optio.vjs_mesg.vva_stat_ereur);
            }
        } //END initl_arbre
