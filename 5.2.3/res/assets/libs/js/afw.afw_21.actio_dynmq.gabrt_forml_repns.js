/**
 * @namespace afw.afw_21.actio_dynmq.gabrt_forml_repns
 */
afw.afw_21.actio_dynmq.gabrt_forml_repns = {
    insta: [],
    obten: function (pnu_id) {
        var vjs_insta;

        for (var i = 0; i < afw.afw_21.actio_dynmq.gabrt_forml_repns.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.gabrt_forml_repns.insta[i].id == pnu_id) {
                vjs_insta = afw.afw_21.actio_dynmq.gabrt_forml_repns.insta[i];
                break;
            }
        }
    ...
    suprm: function (pnu_id) {
        for (var i = 0; i < afw.afw_21.actio_dynmq.gabrt_forml_repns.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.gabrt_forml_repns.insta[i].id == pnu_id) {
                afw.afw_21.actio_dynmq.gabrt_forml_repns.insta.splice(i, 1);
     ...
     * @constructor
     */
    gabrt_forml_repns: function (pjs_optio) {
        ...
        function fermr_detr() {
            afw.afw_21.actio_dynmq.gabrt_forml_repns.suprm(that.id);
        } //END fermr_detr
