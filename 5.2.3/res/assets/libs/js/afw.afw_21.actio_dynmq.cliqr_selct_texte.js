/**
 * @namespace afw.afw_21.actio_dynmq.cliqr_selct_texte
 */
afw.afw_21.actio_dynmq.cliqr_selct_texte = {
    insta: [],
    /**
     * @constructor
     */
    cliqr_selct_texte: function (pjs_optio) {
        var that = this;
        this.node = false;
        this.id = false;
        this.initl = initl;
        ...
        function initl(pjs_optio) {
            ...
            if (that.node) {
                ...
                that.jQuery('#' + that.optio.vva_item_sourc).click(function () {
                    selct_text_group(that.optio.vjs_cible)
                });
