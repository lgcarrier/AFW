/**
 * @namespace afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter
 */
afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter = {
    insta: [],
    obten: function (pnu_id) {
        var vjs_insta;

        for (var i = 0; i < afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter.insta[i].id == pnu_id) {
                vjs_insta = afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter.insta[i];
                break;
            }
        }
    ...
    suprm: function (pnu_id) {
        for (var i = 0; i < afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter.insta[i].id == pnu_id) {
                afw.afw_21.actio_dynmq.trans_ident_coln_raprt_inter.insta.splice(i, 1);
            }
        }
    },
    /**
     * @constructor
     */
    trans_ident_coln_raprt_inter: function (pjs_optio) {
