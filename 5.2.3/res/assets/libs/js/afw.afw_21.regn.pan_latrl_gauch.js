/**
 * @namespace afw.afw_21.regn.pan_latrl_gauch
 */
afw.afw_21.regn.pan_latrl_gauch = {
  insta: [],
  /**
  * @constructor
  */
  pan_latrl_gauch: function (pjs_optio){
    ...
    function initl(pjs_optio) {
      ...
      if(that.node){
        ...
        if ((afw.afw_13.page.obten_numr_apex() == 1 && afw.afw_07.temn.obten("afw.afw_21.regn.pan_latrl_gauch")=="") || afw.afw_07.temn.obten("afw.afw_21.regn.pan_latrl_gauch")=="ouvri") {
          genr_pan_ouver();
        }
        else {
          genr_pan_fermr();
    ...
    function cachr() {
      afw.afw_07.temn.defnr("afw.afw_21.regn.pan_latrl_gauch","fermr",3600);
    ...
    function afich() {
      afw.afw_07.temn.defnr("afw.afw_21.regn.pan_latrl_gauch","ouvri",3600);
