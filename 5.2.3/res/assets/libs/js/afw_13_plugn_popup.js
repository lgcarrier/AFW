...
afw.afw_13.plugn_popup_retr = function (seqnc, afich) {
...
(function ($) {
    $.widget("ui.afw_13_plugn_popup", {
        ...
        _init: function () {
            apex.debug('ui.afw_13_plugn_popup');
...
function sem_selct_espac_docmn(app_id, session, sidf, request, id_champ_docmn) {
    ...
    g_request = request;
    afw_PopUp(url, "Attacher_document", 800, 600, 'no', 'no',
...
function sem_selct_logo(app_id, session, sidf, id_champ_seqnc, id_champ_nom) {
    ...
    afw_PopUp(url, "selct_logo", 800, 600, 'no', 'no',
...
function sem_editr_html(app_id, session, sidf, id_champ_html, id_div_html) {
    ...
    afw_PopUp(url, "editr_html", 640, 480, 'no', 'no', null, null,
...
function sem_selct_dosr(app_id, session, sidf, id_champ_seqnc, request) {
    ...
    /*afw_PopUp (url, "selct_dosr", 800, 600, 'no', 'no',
     ById(id_champ_seqnc), null, sem_calbc_selct_dosr);*/

    afw.jQuery(document).afw_13_plugn_popup({
