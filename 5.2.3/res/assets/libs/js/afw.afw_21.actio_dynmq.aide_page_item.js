/**
 * @namespace afw.afw_21.actio_dynmq.aide_page_item
 */
afw.afw_21.actio_dynmq.aide_page_item = {
    vva_plugn_ajax: "",
    vbo_afich_multp: false,
    afich: function (pnu_numr_apex_page_item) {
        afw.jQuery.exec_aplic_procs({
            plugn_ajax: afw.afw_21.actio_dynmq.aide_page_item.vva_plugn_ajax,
            ...
            sucs_procs: function (pva_mesg_aide) {
                ...
                afw.jQuery(pva_mesg_aide).dialog({
                    autoOpen: true,
                    title: "Help",
                    modal: afw.afw_21.actio_dynmq.aide_page_item.vbo_afich_multp,
                    resizable: false,
                    closeOnEscape: true,
                    dialogClass: "",
                    draggable: true,
