/**
 * @namespace afw.afw_21.regn.acord_menu
 */
afw.afw_21.regn.acord_menu = {
    ...
    acord_menu: function (pjs_optio) {
        ...
        function initl(pjs_optio) {
            ...
            if (that.node) {
                ...
                that.stock_sesn_sectn_ouver = "afw.afw_21.regn.acord_menu." + afw.afw_07.sesn.obten_numr_apex() + ".sectn_ouver";
                that.stock_sesn_stat_plugn = "afw.afw_21.regn.acord_menu." + afw.afw_07.sesn.obten_numr_apex() + ".stat_plugn";
                ...
                try {
                    that.jQuery(that.node).accordion({
                        ...
                        active: parseInt((afw.afw_07.stock_sesn.obten_item(that.stock_sesn_sectn_ouver) == "") ? 0 : afw.afw_07.stock_sesn.obten_item(that.stock_sesn_sectn_ouver)),
                    ...
                    that.jQuery(that.node).bind('accordionchange', function (event, ui) {
                        ...
                        afw.afw_07.stock_sesn.defnr_item(that.stock_sesn_sectn_ouver, vnu_noeud_actif);
                    });
