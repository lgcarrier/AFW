afw.afw_21.actio_dynmq.confr_sauvg = {
    insta: [],
    obten: function (pnu_id) {
        var vjs_insta;

        for (var i = 0; i < afw.afw_21.actio_dynmq.confr_sauvg.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.confr_sauvg.insta[i].id == pnu_id) {
                vjs_insta = afw.afw_21.actio_dynmq.confr_sauvg.insta[i];
                break;
            }
        }
    ...
    suprm: function (pnu_id) {
        for (var i = 0; i < afw.afw_21.actio_dynmq.confr_sauvg.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.confr_sauvg.insta[i].id == pnu_id) {
                afw.afw_21.actio_dynmq.confr_sauvg.insta.splice(i, 1);
            }
        }
    },
    /**
     * @constructor
     */
    confr_sauvg: function (pjs_optio) {
        ...
        this.optio = {
            ...
            vjs_icone_sauvg: {
                ...
                vva_icone_sauvg: "/res/afw/assets/img/afw_19_boutn/sauvg.png",
                vva_icone_confr_sauvg: "/res/afw/assets/img/afw_19_boutn/confr_sauvg.png",
                vnu_icone_temps_rafrc: 2500,
                vva_afw_19_boutn: "afw_19_boutn_sauvg_enreg"
            }
        };
        ...
        function initl(pjs_optio) {
            ...
            that.jQuery(window).bind("beforeunload.afw_21_actio_dynmq_confr_sauvg", function () {
        ...
        function _bascl_icone() {
            if (that.jQuery('#' + that.optio.vjs_icone_sauvg.vva_afw_19_boutn).attr("src") == that.optio.vjs_icone_sauvg.vva_icone_sauvg) {
                that.jQuery('#' + that.optio.vjs_icone_sauvg.vva_afw_19_boutn).attr("src", that.optio.vjs_icone_sauvg.vva_icone_confr_sauvg);
            } else {
                that.jQuery('#' + that.optio.vjs_icone_sauvg.vva_afw_19_boutn).attr("src", that.optio.vjs_icone_sauvg.vva_icone_sauvg);
            }
        } //END _bascl_icone
        ...
        function _afect_actio_item(pjs_page_item) {
            ...
            that.jQuery(vva_jquer_selct).bind('change.afw_21_actio_dynmq_confr_sauvg  keyup.afw_21_actio_dynmq_confr_sauvg', function () {
