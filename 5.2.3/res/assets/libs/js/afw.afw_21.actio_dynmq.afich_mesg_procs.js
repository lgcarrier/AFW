/**
 * @namespace afw.afw_21.actio_dynmq.afich_mesg_procs
 */
afw.afw_21.actio_dynmq.afich_mesg_procs = {
    insta: [],
    obten: function (pnu_id) {
        var vjs_insta;

        for (var i = 0; i < afw.afw_21.actio_dynmq.afich_mesg_procs.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.afich_mesg_procs.insta[i].id == pnu_id) {
                vjs_insta = afw.afw_21.actio_dynmq.afich_mesg_procs.insta[i];
                break;
            }
        }
    ...
    suprm: function (pnu_id) {
        for (var i = 0; i < afw.afw_21.actio_dynmq.afich_mesg_procs.insta.length; i++) {
            if (afw.afw_21.actio_dynmq.afich_mesg_procs.insta[i].id == pnu_id) {
                afw.afw_21.actio_dynmq.afich_mesg_procs.insta.splice(i, 1);
            }
        }
    },
    /**
     * @constructor
     */
    afich_mesg_procs: function (pjs_optio) {
